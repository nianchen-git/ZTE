...
var leftFocusPosition = ['196','308','420','539','642','759','867','979'];
var topFocusPosition = ['74','64','42','40','42','44','64','74'];
...
//    $('bottom_menu_focus_'+bottomMenuIndex).style.visibility = 'visible';
    $("bottom_menu_focus").style.webkitTransitionDuration = "250ms";
//    alert('SSSSSSSSSSSSSSSSSSSS='+bottomMenuIndex);
//    alert('SSSSSSSSSSSSSSSSSSSS='+topFocusPosition[bottomMenuIndex]);
//    alert('SSSSSSSSSSSSSSSSSSSS='+leftFocusPosition[bottomMenuIndex]);
    $('bottom_menu_focus').style.left = leftFocusPosition[bottomMenuIndex]+"px";
    $("bottom_menu_focus").style.webkitTransitionDuration = "250ms";
    $('bottom_menu_focus').style.top = topFocusPosition[bottomMenuIndex]+"px";
...
<body bgcolor="transparent">
 ...
 <div style="position:absolute; width:1280px; height:720px; left:0px; top:490px; font-size:28px;" align="center">
    ...
    <%--我的tv--%>
    <div id="bottom_menu_focus" style=" position:absolute; width:116px; height:116px; left:539px; top:40px; ">
