...
<div style="position:absolute; width:1279px; height:183px; left:0px; top:537px; ">
 ...
 <div style="position:absolute; width:1280px; height:200; left:0px; top:485px; font-size:28px;" align="center">
    ...
    <%--我的tv--%>
        ...
        <div id="bottom_menu_text_0" style=" position:absolute; width:116px; height:30px; left:204px; top:175px; color:#ffffff; font-size:
		26">
            看吧
        </div>
...
var gourla = 'http://61.135.89.195/epg_index.php?UserID='+userid+'&channel_num='+now_channel_num+'&vender=zte&group=epg10&page=see_child&ReturnURL='+returnurl;
if(isZTEBW == true){
...
%>
//看吧
var mytvArr = [{tvname:'点击进入看吧',tvurl:gourl}];
//订制空间
