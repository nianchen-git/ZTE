...
<%
	...
	String timeFrameUrl = timeBasePath +"function";
%>
          ...
          //  alert("SSSSSSSSSSSSSSSSSSSSfavorite_service_lastChannelNum="+lastChannelNum);
            if(isZTEBW == true){
                ...
                if("CTCSetConfig" in Authentication){
                    Authentication.CTCSetConfig('EPGDomain', "<%=timeFrameUrl%>/index.jsp");
                }else{
                    Authentication.CUSetConfig('EPGDomain', "<%=timeFrameUrl%>/index.jsp");
                }
            }else{
                Authentication.CUSetConfig('EPGDomain', "<%=timeFrameUrl%>/index.jsp");
            }
