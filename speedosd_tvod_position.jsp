...
<div id="pro">
    ...
    <div id="div0" style="left:286px;width:60px; height:60px; position:absolute; top: 555px; visibility:hidden;" >
        <img src="images/vod/btv-02-focuss.png" style="width:60px; height:60px;" border="0" alt=""/>	</div>
    <div id="div1" style="left:350px; width:76px; height:76px; position:absolute; top: 546px;visibility:hidden;" >
        <img src="images/vod/btv-02-focus.png" style="width:76px; height:76px;" border="0" alt=""/>	</div>
    ...
    <div style="left:510px; top:582px;width:0px;height:3px; position:absolute;">
        <img id="speedBarDiv" src="images/vod/btv-02-progressred2.png" width="0" height="3" alt="">    </div>
    <div id="icon" style="left:508px; top:570px;width:26px;height:26px; position:absolute; ">
            <img src="images/vod/btv-02-progressico2.png" alt="" width="26" height="26" border="0">    </div>
...
<div id="locTime" style="left:1100px; top:30px;width:30px;height:28px; position:absolute;font-size:30px;color:#FFFFFF;visiblity:hidden">
</div>
